...
namespace XadrezConsole.Xadrez
{
    class PartidaDeXadrez
    {
        ...
        private void desfazMovimento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
            ...
            p.decrementarQuantidadeteMovimento();
            if (pecaCapturada != null)
            {
        ...
        public void validarPosicaoDeDestino(Posicao origem, Posicao destino)
        {
            ...
            {
                throw new TabuleiroExcepition("Posição destino invalida!");
            }
        }
        ...
        public bool estaEmXeque(Cor corRei)
        {
            Peca R = rei(corRei);
            if (R == null)
            {
                throw new TabuleiroExcepition("Nao existe rei da cor " + corRei + " no tabuleiro!");
            }

            foreach (Peca x in pecasEmJogo(adversaria(corRei)))
            {
